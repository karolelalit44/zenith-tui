...
class SubAgentTool(BaseTool):
    ...
    def get_schema(self) -> dict:
        return {"type": "object", "properties": {"task": {"type": "string", "description": "Sub-agent task description"}, "description": {"type": "string", "description": "Short 3-5 word summary"}}, "required": ["task", "description"]}
    ...
    async def execute(self, params: dict[str, Any], workspace_root: str) -> ToolResult:
        ...
        if self._provider is None:
            return ToolResult(success=False, error="No provider available for sub-agent. Configure a provider first.")
        ...
        try:
            ...
            return ToolResult(success=True, output=output[:10000], metadata={"sub_task": description})
