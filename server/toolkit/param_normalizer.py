...
_PATH_CANONICAL_ALIASES = {"path", "filepath", "filename", "file", "targetfile", "targetpath", "dest", "destination", "outputfile", "outputpath", "pathname", "relpath", "absolutepath", "src", "source", "sourcefile"}

_OLD_CONTENT_CANONICAL_ALIASES = {"search", "oldstring", "find", "original", "oldcontent", "targetcontent", "oldtext", "targettext"}

_NEW_CONTENT_CANONICAL_ALIASES = {"replace", "newstring", "replacement", "newcontent", "replacementcontent", "newtext", "replacementtext"}
