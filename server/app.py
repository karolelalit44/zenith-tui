...
class AppContainer:
    ...
    event_bus: EventBus = field(default=None)
    session_repo: SessionRepository = field(default=None)
    message_repo: MessageRepository = field(default=None)
    provider_registry: ProviderRegistry = field(default=None)
    active_provider: BaseProvider | None = None
    tool_registry: ToolRegistry = field(default=None)
    runtime: AgentRuntime = field(default=None)
    coordinator: CoordinatorService = field(default=None)
    context_manager: ContextManager = field(default=None)
    session_service: SessionService = field(default=None)
