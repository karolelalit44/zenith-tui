...
ZENITH_MAX_TOKENS: int = int(os.environ.get("ZENITH_MAX_TOKENS") or 8192)
ZENITH_TEMPERATURE: float = float(os.environ.get("ZENITH_TEMPERATURE") or 0.7)
ZENITH_STREAM_TIMEOUT: float = float(os.environ.get("ZENITH_STREAM_TIMEOUT") or 180.0)
ZENITH_STREAM_TTFT_TIMEOUT: float = float(os.environ.get("ZENITH_STREAM_TTFT_TIMEOUT") or 120.0)
...
_CANONICAL_VARS: dict[str, str] = {
    ...
    "ZENITH_STREAM_TIMEOUT": str(ZENITH_STREAM_TIMEOUT),
    "ZENITH_STREAM_TTFT_TIMEOUT": str(ZENITH_STREAM_TTFT_TIMEOUT),
