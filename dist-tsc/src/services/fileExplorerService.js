export const WORKSPACE_FILES = [
    ...
    {
        name: 'Input',
        relativePath: 'src/components/Input',
        isDir: true,
        fileType: 'Folder',
        parentPath: 'src/components',
    },
    ...
    {
        name: 'AutocompleteDropdown.tsx',
        relativePath: 'src/components/Input/AutocompleteDropdown.tsx',
        isDir: false,
    ...
    // tests Files
    {
        ...
        modifiedDate: 'Jul 22, 2026',
        fileType: 'TypeScript Test',
        parentPath: 'tests',
    },
];
export function getDirectoryContents(parentPath) {
