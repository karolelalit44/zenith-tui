...
function convertEventsToMarkdown(events, prompt) {
    const lines = [];
...
export function savePlanToFile(events, prompt, targetDirectory = process.cwd(), filename = 'implementation-plan.md') {
    try {
