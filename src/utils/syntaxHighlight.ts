...
const KEYWORDS = new Set([
  ...
  'return', 'if', 'else', 'switch', 'case', 'for', 'while', 'do', 'try', 'catch',
  'async', 'await', 'def', 'pass', 'raise', 'in', 'is', 'not', 'and', 'or',
  'public', 'private', 'protected', 'extends', 'implements', 'interface', 'type'
]);

const BUILTIN_TYPES = new Set([
  'FastAPI', 'BaseModel', 'APIRouter', 'HTTPException', 'Optional', 'List', 'Dict',
  'User', 'React', 'FC', 'useState', 'useEffect', 'useCallback', 'useMemo', 'str',
  'int', 'float', 'bool', 'list', 'dict', 'set', 'tuple', 'string', 'number', 'boolean',
